...
function SurveyPositionSection() {
  ...
  return (
    <SectionWrapper>
      <ContentWrapper>
        <ArrowWrapper>
          <StyledLeftArrow onClick={() => setSurveySection("preference")}/>
          <PageNumber>
            5/6
          </PageNumber>
          <StyledRightArrow onClick={() => setSurveySection("info")}/>
        </ArrowWrapper>
        ...
        <TitleWrapper>
          ...
          <Description>
            <div>공포 테마에서 나는?</div>
            <div>선두에서 이끄는 용자 vs. 뒤에서 숨어있는 생존자</div>
          </Description>
        </TitleWrapper>
...
export default SurveyPositionSection;
