    ...
    <SectionWrapper>
      <ContentWrapper>
        <ArrowWrapper>
          ...
          <StyledRightArrow onClick={handleNextSection}/>
        </ArrowWrapper>
      ...
      <ButtonWrapper>
        <StyledButton onClick={handleNextSection} disabled={!selectedLevel}>
          <ButtonText disabled={!selectedLevel}>{selectedLevel ? '다음으로' : '질문 넘기기'}</ButtonText>
        </StyledButton>
